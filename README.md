...
[![Static Badge](https://img.shields.io/badge/Loader-Fabric-f6f7d9)
](https://fabricmc.net/)
## EVIL WICKED MOD... 
\
Hit Minecraft Mod Immurement.  
Enjoy what (not very well-made) content is here.\
*updated 11/17/25 at 5:40PM*\
Contact me on [Twitter](https://x.com/ItzKevlarr) or Discord if needed!

-----------------------------------------------------------------------------------------

You may not modify or adapt the works within this mod, and may only redistribute if credit (to me, the creator) is given and if used for NONcommerical purposes.
